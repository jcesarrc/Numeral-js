var numeral = require('../../numeral'),
    language = require('../../languages/in-id');

numeral.language('in-id', language);

exports['language:in-id'] = {
    ...
    currency: function (test) {
        ...
        var tests = [
            [1000.234,'$0,0.00','full','Rp 1.000,23'],
            [-1000.234,'($0,0)','rounded','(Rp 1.000)'],
            [-1000.234,'$0.00','full','(Rp 1.000,23)'],
            [1230974,'($0.00a)','abbr','Rp 1,23mio']
        ];
