var numeral = require('../../numeral'),
    language = require('../../languages/ms-my');

numeral.language('ms-my', language);

exports['language:ms-my'] = {
    setUp: function (callback) {
        numeral.language('ms-my');
        callback();
    },
    ...
    currency: function (test) {
        ...
        var tests = [
            [1000.234,'$0,0.00','full','RM 1,000.23'],
            [-1000.234,'($0,0)','rounded','(RM 1,000)'],
            [-1000.234,'$0.00','full','(RM 1,000.23)'],
            [1230974,'($0.00a)','abbr','RM 1.23mio']
        ];
